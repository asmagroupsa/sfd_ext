...
@Component({
  selector: 'jhi-taux-sfd',
  templateUrl: './taux-sfd.component.html'
})
export class TauxSFDComponent implements OnInit, OnDestroy {
  currentAccount: any;
  tauxSFDS: TauxSFD[];
  error: any;
  success: any;
 ...
 //this.page = page;
  ...
  trackId(index: number, item: TauxSFD) {
    return item.id;
  }
