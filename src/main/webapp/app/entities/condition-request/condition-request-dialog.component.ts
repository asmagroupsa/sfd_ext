...
@Component({
  selector: 'jhi-condition-request-dialog',
  templateUrl: './condition-request-dialog.component.html'
})
export class ConditionsDialogComponent implements OnInit {
  ...
  private subscribeToSaveResponse(
    result: Observable<ConditionRequest>,
    isCreated: boolean
  ) {
    result.subscribe(
      (res: ConditionRequest) => this.onSaveSuccess(res, isCreated),
      (res: Response) => this.onSaveError(res)
    );
  }

  private onSaveSuccess(result: ConditionRequest, isCreated: boolean) {
...
@Component({
  selector: 'jhi-condition-request-popup',
  template: ''
})
