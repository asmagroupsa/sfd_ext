...
@Component({
    selector: "jhi-produit-type-garantie",
    templateUrl: "./produit-type-garantie.component.html"
})
export class ProduitTypeGarantieComponent implements OnInit, OnDestroy {
    currentAccount: any;
    produitTypeGaranties: ProduitTypeGarantie[];
    error: any;
    success: any;
    ...
    transition() {
        this.router.navigate(["/entity", "tranche-penal"], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ProduitTypeGarantie) {
        return item.id;
    }
    ...
    private onSuccess(data, headers) {
        ...
        this.produitTypeGaranties = data;
    }
