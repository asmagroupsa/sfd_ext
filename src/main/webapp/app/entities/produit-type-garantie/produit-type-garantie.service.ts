...
@Injectable()
export class ProduitTypeGarantieService {
  private resourceUrl = HOST + '/api/produit-type-garanties';
  private resourceSearchUrl = HOST + '/api/_search/produit-type-garanties';

  constructor(private http: Http, private dateUtils: JhiDateUtils) {}

  create(tranchePenal: ProduitTypeGarantie): Observable<ProduitTypeGarantie> {
  ...
  update(tranchePenal: ProduitTypeGarantie): Observable<ProduitTypeGarantie> {
    const copy = this.convert(tranchePenal);
    const options = createRequestOption();
    return this.http
  ...
  find(id: number): Observable<ProduitTypeGarantie> {
    const options = createRequestOption();
    return this.http
  ...
  private convert(tranchePenal: ProduitTypeGarantie): ProduitTypeGarantie {
    const copy: ProduitTypeGarantie = Object.assign({}, tranchePenal);
