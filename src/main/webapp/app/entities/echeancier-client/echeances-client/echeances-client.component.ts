...
@Component({
  selector: "jhi-echeances-client",
  templateUrl: "./echeances-client.component.html"
})
export class EcheancesClientComponent implements OnInit, OnDestroy {
  @Input() idEcheancier: number;
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "echeances-client"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: EcheancesClient) {
    return item.id;
  }
