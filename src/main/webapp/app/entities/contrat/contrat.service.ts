...
export class ContratService {
  private resourceUrl = HOST + '/api/contrats';
  private resourceSearchUrl = HOST + '/api/_search/contrats';
  ...
  private convertItemFromServer(entity: any) {
    entity.contratDate = this.dateUtils.convertLocalDateFromServer(
      entity.contratDate
    );
    entity.clotureDate = this.dateUtils.convertLocalDateFromServer(
      entity.clotureDate
    );
  ...
  private convert(contrat: Contrat): Contrat {
    ...
    copy.contratDate = this.dateUtils.convertLocalDateToServer(
      contrat.contratDate
    );
    copy.clotureDate = this.dateUtils.convertLocalDateToServer(
      contrat.clotureDate
    );
