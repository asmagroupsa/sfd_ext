...
@Component({
  selector: 'jhi-operation-compte-tranche-tf',
  templateUrl: './operation-compte-tranche-tf.component.html'
})
export class OperationCompteTrancheTFComponent implements OnInit, OnDestroy {
  currentAccount: any;
  operationCompteTrancheTFS: OperationCompteTrancheTF[];
  error: any;
  success: any;
 ...
 //this.page = page;
  ...
  transition() {
    this.router.navigate(['/operation-compte-tranche-tf'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: OperationCompteTrancheTF) {
    return item.id;
  }
...
//this.page = this.pagingParams.page;
    ...
    this.operationCompteTrancheTFS = data;
  }
