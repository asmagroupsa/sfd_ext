...
@Component({
  selector: "jhi-types-contrat",
  templateUrl: "./types-contrat.component.html"
})
export class TypesContratComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "typesContrat"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: TypesContrat) {
    return item.id;
  }
