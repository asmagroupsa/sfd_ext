...
@Component({
    selector: 'jhi-credit-fiche-contrat-solidaire',
    templateUrl: './credit-fiche-contrat-solidaire.component.html',
    styleUrls: ['../../shared/state/state.css']
})

export class CreditContratSolidaireComponent implements OnInit, OnDestroy {
    
    private _creditId: number;
    private _subscription: Subscription;
    public data: any;
    private amountGarantie:any;
   /*  private amountNominal:any; */
    private amountTotal:any;
    private sfdName:any;
    private qrConcatInfos: any;
    ...
    private _loadData(): void {
        ...
        .then((data: any) => {
            ...
            /* this.amontNoInteret=data.montant;
            this.amountInteret */
           

            this.amountGarantie=(data.nominal*10)/100;
