import {
  ...
  @Component({
    selector: 'jhi-credit-souffrance',
    templateUrl: './credit-souffrance.component.html',
    styleUrls: ['../../../shared/state/state.scss']
  })
  export class CreditSouffranceComponent {
    credits: any[];
    error: any;
    success: any;
    ...
    loadAll(date?: string) {
      ...
      console.log('sfd_id -> ' + sfd_id);
        ...
        this.creditService
            .getSouffranceCreditListBySFD(sfd_id)
            //.getSouffranceCreditListBySFD(0)
            .subscribe(
                (res: any) => {
                  console.log(res);
