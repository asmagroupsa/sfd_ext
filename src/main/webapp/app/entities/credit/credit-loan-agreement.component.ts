...
@Component({
    selector: 'jhi-credit-loan-agreement',
    templateUrl: './credit-loan-agreement.component.html',
    styleUrls: ['../../shared/state/state.css']
})
export class CreditLoanAgreementComponent implements OnInit, OnDestroy {
    ...
    private _loadData(): void {
        ...
        .then((data: any) => {
            ...
            this.data = data;
            this.montant_en_lettre = toWords(this.data.montant)
