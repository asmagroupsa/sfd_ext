...
@Component({
    selector: 'jhi-list-depot-retrait-local',
    templateUrl: './list-depot-retrait-local.component.html'
})
export class ListeOperationGuichetierComponent implements OnInit, OnDestroy {
    operations = [];
    // currentAccount: any;
    ...
    listeOperationGuichetier(params?) {
        this.operationService.listeOperationGuichetier(params)
        .subscribe(
            (operations) => {
