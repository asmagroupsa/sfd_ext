...
export class BudgetService {
  private resourceUrl = HOST + '/api/budgets';
  private resourceSearchUrl = HOST + '/api/_search/budgets';
  ...
  private convertItemFromServer(entity: any) {
    entity.activeDate = this.dateUtils.convertLocalDateFromServer(
      entity.activeDate
    );
  ...
  private convert(budget: Budget): Budget {
    ...
    copy.activeDate = this.dateUtils.convertLocalDateToServer(
      budget.activeDate
    );
