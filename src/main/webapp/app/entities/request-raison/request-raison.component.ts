...
@Component({
  selector: "jhi-request-raison",
  templateUrl: "./request-raison.component.html"
})
export class RequestRaisonComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "request-raison"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: RequestRaison) {
    return item.id;
  }
