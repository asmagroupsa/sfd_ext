...
@Component({
  selector: "jhi-remboursement-sfd",
  templateUrl: "./remboursement-sfd.component.html",
  styleUrls: ["./remboursement-sfd.component.scss"]
})
export class RemboursementSFDComponent implements OnInit, OnDestroy {
  currentAccount: any;
  remboursementSFDS: RemboursementSFD[];
  error: any;
  success: any;
  ...
  transition() {
    this.router.navigate(["/entity", "remboursement-sfd"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: RemboursementSFD) {
    return item.id;
  }
