...
@Component({
  selector: "jhi-echeancier-sfd",
  templateUrl: "./echeancier-sfd.component.html"
})
export class EcheancierSFDComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "echeancier-sfd"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: EcheancierSFD) {
    return item.id;
  }
