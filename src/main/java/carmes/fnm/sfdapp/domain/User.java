...
public class User extends AbstractAuditingEntity implements Serializable {
    ...
    private Boolean firstConnection = null;
    
    @Column(name = "date_function")
    private Instant dateFunction = null;
    
    @Column(name = "date_end_function")
    private Instant dateEndFunction = null;
