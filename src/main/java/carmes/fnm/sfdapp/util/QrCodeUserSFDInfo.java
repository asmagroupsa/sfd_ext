...
public class QrCodeUserSFDInfo {
	private Long id;
	...
	private String sfd_phone;
	private String indice;
	private String sfd_email;
	private String carte_url;
	
	public QrCodeUserSFDInfo(Long id, String login, String last_name, String first_name, String authority_name,
			String image_url, String signature_url, Instant date_function, Instant date_end_function, String phone,
			String user_email, String sfd_name, String sfd_phone, String indice, String sfd_email, String carte_url) {
		super();
		this.id = id;
		this.login = login;
		...
		this.sfd_phone = sfd_phone;
		this.indice = indice;
		this.sfd_email = sfd_email;
	...
	public String getSfd_phone() {
		return sfd_phone;
	}
	public void setSfd_phone(String sfd_phone) {
		this.sfd_phone = sfd_phone;
	}
	...
	public String getSfd_email() {
		return sfd_email;
	}
	public void setSfd_email(String sfd_email) {
		this.sfd_email = sfd_email;
	}
