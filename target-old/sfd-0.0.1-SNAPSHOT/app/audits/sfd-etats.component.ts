...
import { UserData, searchRessource, nameAgence, nameSFD } from '../shared';

@Component({
    selector: 'jhi-sfd-etats',
    templateUrl: './sfd-etats.component.html',
})
export class SfdEtatsComponent implements AfterViewInit, OnInit {
    date1: any;
    date2: any;
    loading = true;
    q: any = {};
    ...
    getData(isBenef:boolean = false) {
        ...
        if(isBenef || this.selectedSate) stateUrl = 'sfd/' + this.q.link + '-beneficiaire/file';
    ...
    switchable() {
        return (this.q.link !== 'credits-solde');
    }
