...
@Component({
  selector: 'jhi-setting-sfd',
  templateUrl: './setting-sfd.component.html'
})
export class SettingSFDComponent implements OnInit, OnDestroy {
  currentAccount: any;
  settingSFDS: SettingSFD[];
  error: any;
  success: any;
 ...
 //this.page = page;
  ...
  transition() {
    this.router.navigate(['/setting-sfd'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: SettingSFD) {
    return item.id;
  }
