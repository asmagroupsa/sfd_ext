...
@Component({
  selector: 'jhi-type-rembt',
  templateUrl: './type-rembt.component.html'
})
export class TypeRembtComponent implements OnInit, OnDestroy {
  currentAccount: any;
 ...
 //this.page = page;
  ...
  transition() {
    this.router.navigate(['/type-rembt'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: TypeRembt) {
    return item.id;
  }
