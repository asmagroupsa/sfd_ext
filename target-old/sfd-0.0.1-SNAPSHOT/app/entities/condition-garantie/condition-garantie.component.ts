...
@Component({
  selector: "jhi-condition-garantie",
  templateUrl: "./condition-garantie.component.html"
})
export class ConditionGarantieComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "condition-garantie"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: ConditionGarantie) {
    return item.id;
  }
