...
export class AnneeService {
  private resourceUrl = HOST + "/api/cautions";
  private resourceSearchUrl = HOST + "/api/_search/cautions";

  constructor(private http: Http, private dateUtils: JhiDateUtils) {}

  create(annee: Annee): Observable<Annee> {
    const copy = this.convert(annee);
  ...
  find(id: number): Observable<Annee> {
    const options = createRequestOption();
    return this.http
  ...
  private convert(annee: Annee): Annee {
    const copy: Annee = Object.assign({}, annee);
