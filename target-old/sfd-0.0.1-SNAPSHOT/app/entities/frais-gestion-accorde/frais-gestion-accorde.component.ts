...
@Component({
  selector: 'jhi-frais-gestion-accorde',
  templateUrl: './frais-gestion-accorde.component.html'
})
export class FraisGestionAccordeComponent implements OnInit, OnDestroy {
  currentAccount: any;
  fraisGestionAccordes: FraisGestionAccorde[];
  error: any;
  success: any;
 ...
 //this.page = page;
  ...
  transition() {
    this.router.navigate(['/frais-gestion-accorde'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: FraisGestionAccorde) {
    return item.id;
  }
  ...
  private onSuccess(data, headers) {
    ...
    this.fraisGestionAccordes = data;
  }
