...
@Component({
  selector: 'jhi-document-garantie',
  templateUrl: './document-garantie.component.html'
})
export class DocumentGarantieComponent implements OnInit, OnDestroy {
  currentAccount: any;
  documentGaranties: DocumentGarantie[];
  error: any;
  success: any;
 ...
 //this.page = page;
  ...
  transition() {
    this.router.navigate(['/document-garantie'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: DocumentGarantie) {
    return item.id;
  }
