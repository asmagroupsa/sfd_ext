...
@Injectable()
export class NotificationSFDService {
  private resourceUrl = HOST + '/api/notification-sfds';
  private resourceSearchUrl = HOST + '/api/_search/notification-sfds';

  constructor(private http: Http, private dateUtils: JhiDateUtils) {}

  create(notificationSFD: NotificationSFD): Observable<NotificationSFD> {
    const copy = this.convert(notificationSFD);
  ...
  update(notificationSFD: NotificationSFD): Observable<NotificationSFD> {
    const copy = this.convert(notificationSFD);
    const options = createRequestOption();
    return this.http
  ...
  find(id: number): Observable<NotificationSFD> {
    const options = createRequestOption();
    return this.http
  ...
  private convert(notificationSFD: NotificationSFD): NotificationSFD {
    const copy: NotificationSFD = Object.assign({}, notificationSFD);
