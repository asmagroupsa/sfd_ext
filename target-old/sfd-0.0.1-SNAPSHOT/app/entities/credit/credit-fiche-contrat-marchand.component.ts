...
@Component({
    selector: 'jhi-credit-contrat-marchand',
    templateUrl: './credit-fiche-contrat-marchand.component.html',
    styleUrls: ['../../shared/state/state.css']
})
export class CreditContratMarchandComponent implements OnInit, OnDestroy {
