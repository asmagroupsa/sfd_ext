...
@Component({
    selector: 'jhi-credit-contrat-equipement',
    templateUrl: './credit-fiche-contrat-equipement.component.html',
    styleUrls: ['../../shared/state/state.css']
})
export class CreditContratEquipementComponent implements OnInit, OnDestroy {
    ...
    private mensualite:any;
    private  mensualite_en_lettre:string;
    ...
    private _loadData(): void {
        this._creditService.loanAgreement(this._creditId)
            .then((data: any) => {
                ...
                this.data = data;
                this.nominal_en_lettre = toWords(this.data.nominal);
                this.interet_en_lettre = toWords(this.data.interet);
                this.montant_en_lettre = toWords(this.amountTotal);
                this.mensualite = this.amountTotal/24;
                this.mensualite_en_lettre = toWords(this.mensualite);
