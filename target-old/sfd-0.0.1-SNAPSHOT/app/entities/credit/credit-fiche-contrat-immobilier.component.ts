...
@Component({
    selector: 'jhi-credit-contrat-immobilier',
    templateUrl: './credit-fiche-contrat-immobilier.component.html',
    styleUrls: ['../../shared/state/state.css']
})
export class CreditContratImmobilierComponent implements OnInit, OnDestroy {
    ...
    private _loadData(): void {
        this._creditService.loanAgreement(this._creditId)
            .then((data: any) => {
                ...
                this.amountTotal_en_lettre = toWords(this.amountTotal);
