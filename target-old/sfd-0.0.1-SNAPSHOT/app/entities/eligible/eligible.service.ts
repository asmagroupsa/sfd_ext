...
export class EligibleService {
  private resourceUrl = HOST + '/api/eligibles';
  private resourceSearchUrl = HOST + '/api/_search/eligibles';

  constructor(private http: Http, private dateUtils: JhiDateUtils) {}

  create(eligible: Eligible): Observable<Eligible> {
    const copy = this.convert(eligible);
  ...
  update(eligible: Eligible): Observable<Eligible> {
    const copy = this.convert(eligible);
    const options = createRequestOption();
    return this.http
  ...
  find(id: number): Observable<Eligible> {
    const options = createRequestOption();
    return this.http
  ...
  private convert(eligible: Eligible): Eligible {
    const copy: Eligible = Object.assign({}, eligible);
