...
@Component({
  selector: "jhi-rembt-penal",
  templateUrl: "./rembt-penal.component.html",
  styleUrls: ["./rembt-penal.component.scss"]
})
export class RembtPenalComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(["/entity", "rembt-penal"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: RembtPenal) {
    return item.id;
  }
