...
@Component({
  selector: "jhi-rembt-penal-sfd",
  templateUrl: "./rembt-penal-sfd.component.html",
  styleUrls: ["./rembt-penal-sfd.component.scss"]
})
export class RembtPenalSFDComponent implements OnInit, OnDestroy {
  currentAccount: any;
  rembtPenalSFDS: RembtPenalSFD[];
  error: any;
  success: any;
  ...
  transition() {
    this.router.navigate(["/entity", "rembt-penal-sfd"], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: RembtPenalSFD) {
    return item.id;
  }
